...
def index():
    ...
    return render_template('index.html', **build_stats(logs_by_user, selected_records, rotw_counts, movies_after_date_object))
...
def leaderboard():
    ...
    leaderboard_data = {}
    for username in usernames:
        num_movies_watched = get_user_number_of_movies_watched(username)
        leaderboard_data[username] = num_movies_watched
    # sort leaderboard_data by highest value (most movies watched first)
