...
from cache import is_cache_valid, load_cache, save_cache, CACHE_FILE, flush_cache, load_all_stats_caches_in_memory
from scraper import did_user_watch_movie, user_watched_last_film
from scraper_optimized import get_all_user_logs
from utils import expand_short_url, build_stats, slugify, fetch_page
from utils_optimized import get_rotw_counts
    ...
    if cache is not None:
        ...
        for username in usernames:
            ...
            if username in cache and cache[username] != {} and 'stats' in cache.get(username, {}) and cache[username]['stats'] != {}:
                ...
                rotw_counts[username] = cache[username]['stats']['rotw_count']
            else:
